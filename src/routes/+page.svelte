...
<div class="content">
	<h1 class="pb-3 font-semibold text-3xl text-center">Conveyer Calculator</h1>
	<form class="form-width mx-auto border-2 border-gray-400 p-2 pb-0 m-5">
		<div class="mb-1 mx-auto pb-2">
			...
			<div class="flex items-center me-0 my-2 pb-0.5">
				<input id="purple-checkbox" type="checkbox" on:click={handleClick} bind:checked={bothChecked} value="" class="w-4 h-4 text-purple-600 bg-gray-100 border-gray-300 rounded focus:ring-purple-500 dark:focus:ring-purple-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
				<label for="purple-checkbox" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Both Sides of Belt</label>
			</div>
	...
	<div class="pb-5 flex items-center space-x-2">
		<button
			on:click={setdefault}
	...
	<div class="container-results mx-auto mt-4 mb-16">
		<h2 class="text-gray-600 font-bold text-1xl">Accumulated Entries</h2>
		<ul>
	...
	<div class="container-results mx-auto mt-4 mb-16">
		<h1 class="pb-3 font-semibold text-2xl mt-6">Accumulated Totals</h1>
		<div class="align-results">
			<h2 class="text-gray-600 font-bold text-1xl">STP Dual side switch, includes flag</h2>
